...
import myImage from './th.jpeg'; // Assurez-vous que le chemin est correct
        ...
        {showForgotPassword ? (
          ...
          <form onSubmit={handleSubmit}>
            <Stack direction={"column"} gap={2}>
              ...
              <Button id="button" variant="contained" type="submit">Se Connecter</Button>
              ...
              <div id="divmot2">
                <p className="mot3"> <a href="#"> Pas de compte?</a><a href="#" > Inscrivez-Vous!</a></p>
              </div>
            </Stack>
          </form>
        )}
